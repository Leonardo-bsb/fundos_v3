...
\copy registro_subclasse("ID_Registro_Classe","ID_Subclasse","Codigo_CVM","Data_Constituicao","Data_Inicio","Denominacao_Social","Situacao","Data_Inicio_Situacao","Forma_Condominio","Exclusivo","Publico_Alvo") FROM 'dados/CAD/DADOS/registro_subclasse.csv' WITH (FORMAT csv, HEADER true, DELIMITER ';', ENCODING 'LATIN1');
